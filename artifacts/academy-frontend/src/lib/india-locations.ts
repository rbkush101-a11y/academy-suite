// All States and their respective Districts
export const INDIA_LOCATION_DATA: Record<string, string[]> = {
  ...
  "Chhattisgarh": [
    ...
    "Raipur", "Rajnandgaon", "Sarangarh-Bilaigarh", "Sakti", "Sukma", "Surajpur", "Surguja"
  ],
  "Delhi": [
...
// Function: Returns districts ONLY for the selected state
export const getDistricts = (stateName: string): string[] => {
  if (!stateName || !INDIA_LOCATION_DATA[stateName]) {
    return [];
  }
  return [...INDIA_LOCATION_DATA[stateName]].sort();
};